...
export const mockBackend: backendInterface = {
  ...
  getRecentResults: async () => [
    {
      ...
      phase: { __kind__: "leagueStage", leagueStage: null },
      tournamentId: BigInt(1),
      scheduledAt: BigInt(Date.now() - 172800000),
      completedAt: BigInt(Date.now() - 172800000),
    },
    {
      id: BigInt(2),
      status: MatchStatus.completed,
  ...
  updateScore: async () => undefined,

  updateTournamentStatus: async () => undefined,
};
