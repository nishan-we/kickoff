import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, t as createSlot, v as cn, w as o, x as vt, u as useListTournaments, y as useAddPlayer, g as useGetTeamsByTournament, B as Button, z as useAddTeam, a as TournamentFormat, A as useCreateTournament, D as useControllableState, E as useId, P as Presence, F as Primitive$1, G as composeEventHandlers, H as Portal$1, I as useComposedRefs, J as hideOthers, K as createContextScope, R as ReactRemoveScroll, N as useFocusGuards, O as FocusScope, Q as DismissableLayer, V as createSlot$1, W as createContext2, X, Y as useEditPlayer, m as useGetMatchesByTournament, Z as useGenerateFixtures, M as MatchStatus, _ as useUpdateScore, $ as useCompleteMatch, a0 as ChevronDown, a1 as useInternetIdentity, i as useIsAdmin, L as Link, d as Trophy, U as Users, a2 as User, s as useGetPlayersByTeam } from "./index-BMd2UGmK.js";
import { B as Badge } from "./badge-DWBGBwmV.js";
import { C as Card, b as CardHeader, c as CardTitle, a as CardContent } from "./card-B0ahsKQl.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem, C as ChevronUp } from "./select-zBnqW-9V.js";
...
const POSITIONS$1 = ["Goalkeeper", "Defender", "Midfielder", "Forward"];
function AddPlayerForm() {
  const { data: tournaments = [] } = useListTournaments();
  const [tournamentId, setTournamentId] = reactExports.useState("");
  const [teamId, setTeamId] = reactExports.useState("");
  const [name, setName] = reactExports.useState("");
  const [number, setNumber] = reactExports.useState("1");
  const [position, setPosition] = reactExports.useState("Midfielder");
  ...
  function handleSubmit(e) {
    ...
    if (!tournamentId || !teamId) {
      ue.error("Select a tournament and team");
      return;
    }
    const num = Number(number);
    if (num < 1 || num > 99) {
      ue.error("Jersey number must be 1–99");
      return;
    }
    mutate(
      {
      ...
      {
        onSuccess: (p) => {
          ue.success(`${p.name} added to squad!`);
          setName("");
          setNumber("1");
        },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "player-tournament", children: "Tournament" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: tournaments.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: t.id.toString(), children: t.name }, t.id.toString())) })
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "player-team", children: "Team" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            value: teamId,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "player-team", "data-ocid": "admin-player-team", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                SelectValue,
                {
                  placeholder: !tournamentId ? "Select tournament first" : teams.length === 0 ? "No teams yet" : "Select team"
                }
              ) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: teams.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: t.id.toString(), children: t.name }, t.id.toString())) })
            ]
          }
        )
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sm:col-span-2 space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "player-name", children: "Player Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "player-name",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "player-number", children: "Jersey #" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "player-number",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "player-position", children: "Position" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: position, onValueChange: setPosition, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "player-position", "data-ocid": "admin-player-position", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: POSITIONS$1.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: p, children: p }, p)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
...
function AddTeamForm() {
  ...
  function handleSubmit(e) {
    e.preventDefault();
    if (!tournamentId) {
      ue.error("Select a tournament first");
      return;
    }
    mutate(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "team-tournament", children: "Tournament" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: tournamentId, onValueChange: setTournamentId, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "team-tournament", "data-ocid": "admin-team-tournament", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select a tournament" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: tournaments.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-2 px-3 text-sm text-muted-foreground", children: "No tournaments yet" }) : tournaments.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: t.id.toString(), children: t.name }, t.id.toString())) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "team-name", children: "Team Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "team-name",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Team Color" }),
...
function CreateTournamentForm() {
  ...
  const [totalTeams, setTotalTeams] = reactExports.useState("8");
  const { mutate, isPending } = useCreateTournament();
  function handleSubmit(e) {
    e.preventDefault();
    const teamsNum = Number(totalTeams);
    if (!name.trim()) {
      ue.error("Tournament name is required");
      return;
    }
    if (teamsNum < 2 || teamsNum > 64) {
      ue.error("Number of teams must be between 2 and 64");
      return;
    }
    mutate(
      ...
      {
        onSuccess: (t) => {
          ue.success(`Tournament "${t.name}" created!`);
          setName("");
          setTotalTeams("8");
        },
        onError: (err) => ue.error(err.message)
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "t-name", children: "Tournament Name" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          id: "t-name",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "t-format", children: "Format" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            value: format,
            onValueChange: (v2) => setFormat(v2),
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { id: "t-format", "data-ocid": "admin-tournament-format", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: TournamentFormat.league, children: "League — Round robin" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: TournamentFormat.knockout, children: "Knockout — Elimination" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: TournamentFormat.hybrid, children: "League + Knockout" })
              ] })
            ]
          }
        )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "t-teams", children: "Number of Teams" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "t-teams",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Supports 2 to 64 teams" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
...
function EditPlayerModal({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange: (o2) => !o2 && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md", "data-ocid": "edit-player-modal", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display", children: "Edit Player" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4 pt-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-player-name", children: "Full Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "edit-player-name",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-player-number", children: "Jersey #" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "edit-player-position", children: "Position" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: position, onValueChange: setPosition, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              SelectTrigger,
              {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-end pt-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { className: "h-4 w-4 mr-1.5", "aria-hidden": true }),
...
function teamName(teams, id) {
  var _a;
  return ((_a = teams.find((t) => t.id === id)) == null ? void 0 : _a.name) ?? "TBD";
}
function teamColor(teams, id) {
  var _a;
  return ((_a = teams.find((t) => t.id === id)) == null ? void 0 : _a.color) ?? "#6366f1";
}
function ScoreRow({ match, teams, tournamentId }) {
  const [homeScore, setHomeScore] = reactExports.useState(match.homeScore.toString());
  const [awayScore, setAwayScore] = reactExports.useState(match.awayScore.toString());
  ...
  function handleSave() {
    updateScore(
      ...
      {
        onSuccess: () => ue.success("Score updated!"),
  ...
  function handleComplete() {
    completeMatch(
      ...
      {
        onSuccess: () => ue.success("Match marked as Full Time"),
        onError: (e) => ue.error(e.message)
      }
    );
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `rounded-lg border transition-smooth ${isCompleted ? "border-border bg-muted/30 opacity-70" : isLive ? "border-accent/50 bg-accent/5" : "border-border bg-card hover:border-primary/30"}`,
      "data-ocid": "admin-score-row",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 min-w-0 flex-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm truncate", children: teamName(teams, match.homeTeamId) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center shrink-0 px-2", children: [
            isCompleted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-base font-bold font-mono tabular-nums text-muted-foreground", children: [
              match.homeScore.toString(),
              " – ",
              match.awayScore.toString()
            ] }) : isLive ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-base font-bold font-mono tabular-nums text-accent", children: [
              match.homeScore.toString(),
              " – ",
              match.awayScore.toString()
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-mono", children: "vs" }),
            isCompleted && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[10px] mt-0.5", children: "FT" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 min-w-0 flex-1 justify-end", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm truncate", children: teamName(teams, match.awayTeamId) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "h-3 w-3 rounded-full shrink-0",
        ...
        !isCompleted && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-3 pt-1 border-t border-border/50 flex flex-wrap items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  type: "button",
                  onClick: () => setHomeScore(String(Math.max(0, Number(homeScore) + 1))),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-bold", children: "–" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ...
                {
                  type: "button",
                  onClick: () => setAwayScore(String(Math.max(0, Number(awayScore) + 1))),
                  className: "h-5 w-7 flex items-center justify-center rounded-sm bg-muted hover:bg-muted-foreground/20 transition-colors",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 ml-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: updatingScore ? "Saving..." : "Save Score"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-3.5 w-3.5 mr-1", "aria-hidden": true }),
...
function ScoreEditor() {
  ...
  const activeTournamentId = selectedId ? BigInt(selectedId) : ((_a = tournaments[0]) == null ? void 0 : _a.id) ?? null;
  const { data: matches = [], isLoading: loadingM } = useGetMatchesByTournament(activeTournamentId);
  const { data: teams = [] } = useGetTeamsByTournament(activeTournamentId);
  const { mutate: generateFixtures, isPending: generatingFixtures } = useGenerateFixtures();
  if (isLoading) return /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-40" });
  if (tournaments.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground py-6 text-center", children: "No tournaments yet. Create one first." });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", "data-ocid": "score-editor", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Select,
        {
          value: selectedId || ((_b = tournaments[0]) == null ? void 0 : _b.id.toString()),
          onValueChange: setSelectedId,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-56", "data-ocid": "admin-score-tournament", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select tournament" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: tournaments.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: t.id.toString(), children: t.name }, t.id.toString())) })
          ]
        }
      ),
      activeTournamentId && matches.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          variant: "outline",
          onClick: () => generateFixtures(activeTournamentId, {
            onSuccess: () => ue.success("Fixtures generated!"),
            onError: (e) => ue.error(e.message)
          }),
          disabled: generatingFixtures,
          "data-ocid": "admin-generate-fixtures",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "h-4 w-4 mr-1.5", "aria-hidden": true }),
            generatingFixtures ? "Generating..." : "Generate Fixtures"
          ]
        }
      )
    ] }),
    loadingM ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20" })
    ] }) : matches.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-4", children: 'No fixtures yet. Click "Generate Fixtures" to create the schedule.' }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      pending.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground mb-2", children: [
          "Pending / Live (",
          pending.length,
          ")"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: pending.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ScoreRow,
          {
            match: m,
            teams,
      ...
      completed.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: completed.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ScoreRow,
          {
            match: m,
            teams,
...
function PlayerManager() {
  ...
  const [tournamentId, setTournamentId] = reactExports.useState("");
  const [teamId, setTeamId] = reactExports.useState("");
  const [editingPlayer, setEditingPlayer] = reactExports.useState(null);
  const { data: teams = [] } = useGetTeamsByTournament(
    tournamentId ? BigInt(tournamentId) : null
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Tournament" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            value: tournamentId,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "admin-edit-tournament", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select tournament" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: tournaments.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: t.id.toString(), children: t.name }, t.id.toString())) })
            ]
          }
        )
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", children: "Team" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Select,
          {
            value: teamId,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { "data-ocid": "admin-edit-team", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select team" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: teams.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: t.id.toString(), children: t.name }, t.id.toString())) })
            ]
          }
        )
    ...
    loadingP && teamId ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [1, 2, 3].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-12" }, n)) }) : players.length === 0 && teamId ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-8 text-center text-sm text-muted-foreground", children: "No players registered for this team yet." }) : players.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 text-left font-semibold text-muted-foreground", children: "#" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 text-left font-semibold text-muted-foreground", children: "Name" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 text-left font-semibold text-muted-foreground hidden sm:table-cell", children: "Position" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-4 py-2.5 text-right font-semibold text-muted-foreground", children: "Actions" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: players.map((p, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "tr",
        {
          className: `border-t border-border ${i % 2 === 0 ? "bg-card" : "bg-muted/20"}`,
          "data-ocid": "admin-player-row",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-mono text-muted-foreground tabular-nums", children: p.number.toString() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 font-display font-medium", children: p.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 hidden sm:table-cell", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs", children: p.position }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-4 py-3 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { className: "h-3.5 w-3.5 mr-1", "aria-hidden": true }),
                  "Edit"
                ]
              }
            ) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      EditPlayerModal,
      {
        ...
        teamId: teamId ? BigInt(teamId) : (selectedTeam == null ? void 0 : selectedTeam.id) ?? 0n,
  ...
  if (!identity) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-16 w-16 items-center justify-center rounded-full bg-primary/10 shadow-fixture", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-8 w-8 text-primary", "aria-hidden": true }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold mb-2", children: "Admin Access Required" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Sign in with Internet Identity to access the tournament administration panel." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "lg", onClick: () => login(), "data-ocid": "admin-login-btn", children: "Sign in with Internet Identity" })
        ]
      }
    );
  }
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pt-8", children: [
  ...
  if (!isAdmin) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-16 w-16 items-center justify-center rounded-full bg-destructive/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-8 w-8 text-destructive", "aria-hidden": true }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-display font-bold", children: "Access Denied" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm text-center max-w-xs", children: "You do not have administrator privileges for this platform." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: "Back to Dashboard" }) })
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "admin-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 p-5 bg-primary/5 border border-primary/20 rounded-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-6 w-6 text-primary", "aria-hidden": true }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-display font-bold", children: "Admin Panel" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "default", className: "text-xs", children: "ADMIN" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Manage tournaments, teams, players, scores, and fixtures" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "tournaments", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "flex-wrap h-auto gap-1 p-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsTrigger,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "h-3.5 w-3.5", "aria-hidden": true }),
              "Tournaments"
            ]
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsTrigger,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "h-3.5 w-3.5", "aria-hidden": true }),
              "Scores"
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "tournaments", className: "mt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-display flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Trophy, { className: "h-4 w-4 text-primary", "aria-hidden": true }),
          "Create Tournament"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CreateTournamentForm, {}) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "teams", className: "mt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-display flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Users, { className: "h-4 w-4 text-primary", "aria-hidden": true }),
          "Add Team"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AddTeamForm, {}) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "players", className: "mt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-display flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "h-4 w-4 text-primary", "aria-hidden": true }),
          "Register Player"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(AddPlayerForm, {}) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "edit-players", className: "mt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-display flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "h-4 w-4 text-primary", "aria-hidden": true }),
          "Manage Squad"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PlayerManager, {}) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "scores", className: "mt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-base font-display flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { className: "h-4 w-4 text-primary", "aria-hidden": true }),
          "Match Scores & Fixtures"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreEditor, {}) })
      ] }) })
    ] })
  ] });
}
