import { r as reactExports, j as jsxRuntimeExports, p as SkeletonRow } from "./index-BMd2UGmK.js";
...
function PositionBadge({ pos }) {
  if (pos === 1)
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex h-6 w-6 items-center justify-center rounded-full bg-accent/20 border border-accent/40 text-[11px] font-bold text-accent-foreground", children: pos });
  if (pos === 2)
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex h-6 w-6 items-center justify-center rounded-full bg-muted border border-border text-[11px] font-bold text-muted-foreground", children: pos });
  if (pos === 3)
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex h-6 w-6 items-center justify-center rounded-full bg-chart-5/10 border border-chart-5/30 text-[11px] font-bold text-chart-5", children: pos });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex h-6 w-6 items-center justify-center text-[11px] font-medium text-muted-foreground", children: pos });
}
function TeamColorDot({
  teams,
  teamId
}) {
  const team = teams == null ? void 0 : teams.find((t) => t.id === teamId);
  if (!team) return null;
...
function StandingsTable({
  ...
  const headerCls = "px-3 py-3 text-[10px] font-bold tracking-widest text-muted-foreground uppercase text-right";
  const cellCls = "px-3 py-3 text-sm tabular-nums text-right text-muted-foreground";
  const cellNumBold = "px-3 py-3 text-sm tabular-nums text-right font-bold text-foreground";
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full border-collapse", "aria-label": "League standings", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border bg-muted/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `${headerCls} text-left w-8`, children: "#" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `${headerCls} text-left min-w-[120px]`, children: "TEAM" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: headerCls, children: "MP" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: headerCls, children: "W" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: headerCls, children: "D" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: headerCls, children: "L" }),
      !compact && /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: headerCls, children: "GF" }),
      !compact && /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: headerCls, children: "GA" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: headerCls, children: "GD" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: `${headerCls} text-right pr-4`, children: "PTS" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: isLoading ? Array.from({ length: 6 }, (_, i) => i).map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(SkeletonRow, { cols: compact ? 8 : 10 }, i)) : standings.map((row, idx) => {
      const pos = Number(row.position);
      const isHighlighted = highlightTeamId != null && row.teamId === highlightTeamId;
      const isTop3 = pos <= 3;
      const rowBg = isHighlighted ? "bg-primary/5" : isTop3 ? pos === 1 ? "bg-accent/5" : "bg-transparent" : "";
      const borderLeft = pos === 1 ? "border-l-2 border-l-accent" : pos === 2 || pos === 3 ? "border-l-2 border-l-muted-foreground/30" : "border-l-2 border-l-transparent";
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "tr",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 w-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PositionBadge, { pos }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-3 py-2.5 min-w-[120px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TeamColorDot, { teams, teamId: row.teamId }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground truncate", children: row.teamName })
            ] }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: cellCls, children: row.played.toString() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: cellCls, children: row.won.toString() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: cellCls, children: row.drawn.toString() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: cellCls, children: row.lost.toString() }),
            !compact && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: cellCls, children: row.goalsFor.toString() }),
            !compact && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: cellCls, children: row.goalsAgainst.toString() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: cellCls, children: Number(row.goalDifference) > 0 ? `+${row.goalDifference}` : row.goalDifference.toString() }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: `${cellNumBold} pr-4`, children: row.points.toString() })
          ]
        },
        row.teamId.toString()
      );
